      ...
      <div className="right-container">
        ...
        <div className="text-fields">
          ...
          <div className="row">
            ...
            <input type="text" placeholder="Type(Freelancer/Client)" className="input-field" />
          </div>
          {/* Row 3 */}
          <div className="row">
            <input type="text" placeholder="Average Charge" className="input-field" />
            <input type="text" placeholder="Drive link" className="input-field" />
          </div>
          {/* Row 4 */}
          <div className="row">
          ...
          {/* Row 5 */}
          <div className="row">
            <input type="text" placeholder="Task Name" className="input-field" />
            <input type="text" placeholder="Task's Budget" className="input-field" />
          </div>
          {/* Row 6 */}
          <div className="row">
            <input type="text" placeholder="Time Duration" className="input-field" />
            <input type="text" placeholder="Extra amount" className="input-field" />
          </div>
        </div>
        {/* Dropdown fields */}
